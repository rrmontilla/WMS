...
namespace WMS.Controller
{
    public class ConstructionController
    {
        ...
        public int InsertConstruction(string xmlData)
        {
            int retval = 0;
            retval = wms.InsertConstruction(xmlData);
            return retval;
        }
        ...
        public DataSet GetAllConstruction(string title, string subtitle)
        {
            DataSet ds = new DataSet();
            ds = ToXML.ToDataSet(wms.GetAllData(title, subtitle));
            return ds;
        }
